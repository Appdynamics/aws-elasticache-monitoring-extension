#AWS ElastiCache Monitoring Extension
...
1. Run 'mvn clean install' from aws-elasticache-monitoring-extension
2. Copy and unzip AWSElasticacheMonitor-\<version\>.zip from 'target' directory into \<machine_agent_dir\>/monitors/
3. Edit config.yaml file in AWSElasticacheMonitor/conf and provide the required configuration (see Configuration section)
...
- [Redis Metrics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CacheMetrics.Redis.html)

##Contributing

Always feel free to fork and contribute any changes directly via [GitHub](https://github.com/Appdynamics/aws-elasticache-monitoring-extension).
